...
def text_mode(cam):
	...
	while True:
		...
		cv2.putText(blackboard, "Predicted text: " + text, (30, 100), cv2.FONT_HERSHEY_COMPLEX, 1, (140,140,140))
		cv2.putText(blackboard, word, (30, 240), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 0, 0))
		# if is_voice_on:
		# 	cv2.putText(blackboard, "Voice on", (450, 440), cv2.FONT_HERSHEY_TRIPLEX, 1, (255, 127, 0))
		# else:
		# 	cv2.putText(blackboard, "Voice off", (450, 440), cv2.FONT_HERSHEY_TRIPLEX, 1, (255, 127, 0))
...
root = tk.Tk()
root.geometry("1000x711")
root.title("Project in Intelligent System")
